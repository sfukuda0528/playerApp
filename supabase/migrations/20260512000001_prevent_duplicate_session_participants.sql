-- Make joining a session idempotent for the same browser/auth user.
-- The frontend shares Supabase Auth through localStorage across tabs, so a
-- second tab should resume the existing participant instead of consuming a slot.
